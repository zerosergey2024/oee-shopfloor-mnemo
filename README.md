...
Переключение уровня (Windows PowerShell):
$env:OEE_CONFIG="config/advanced.yaml"
streamlit run app.py

🚀 Что можно добавить дальше (идеи развития)

Датчики и PLC: вибрация, температура, токи; OPC UA / MQTT

Диагностика: разбор потерь OEE, микростопы, повторяющиеся причины

Рекомендации: “остановить/продолжить”, ТО, заказ запчастей, оценка риска

Интеграция с 1С/ERP: план-факт, потери в деньгах, заявки на ТО

Планирование ТО: календарь, окна обслуживания, what-if сценарии
